...
fn main() {
    let secret_number: u32 = rand::thread_rng().gen_range(1..=100); //choose a random number between 1-100.
    ...
    loop {
        ...
        println!("\nGuesses remaining: {}", guesses_left.to_string().cyan());
        ...
        match guess.cmp(&secret_number) {
            ...
            Ordering::Equal => {
                ...
                println!("It took you{}attempts.", total_attempts.to_string().green());
                break;
            }
        }
    }
